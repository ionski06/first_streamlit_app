...
def insert_row_snowflake(add_new_fruit):
    with my_cnx.cursor() as my_cur:
        query = "INSERT INTO FRUIT_LOAD_LIST (fruit_name) VALUES (%s)"
        my_cur.execute(query, (add_new_fruit,))
        my_cnx.commit()  # Don't forget to commit the transaction
